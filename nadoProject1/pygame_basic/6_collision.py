...
# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("D:/codingNote/nadoProject/Project1/pygame_basic/character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("D:/codingNote/nadoProject/Project1/pygame_basic/enemy.png")
